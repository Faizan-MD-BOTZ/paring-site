...
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝐅𝐀𝐈𝐙𝐀𝐍-𝐌𝐃 🤍`;
	 await Qr_Code_By_Mbuvi_Tech.sendMessage(Qr_Code_By_Mbuvi_Tech.user.id,{ image: { url: 'https://files.catbox.moe/npizv8.jpg' }, caption: MBUVI_MD_TEXT },{quoted:session})
